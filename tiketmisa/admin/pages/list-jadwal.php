                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><center><?php if($q['aktif']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    } ?></center></td>
                        <td><center><?php if($q['blok1']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    } ?></center></td>
                        <td><center><?php if($q['blok2']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    } ?></center></td>
                        <td><center><?php if($q['blok3']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    } ?></center></td>
                        <td><center><?php if($q['blok4']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    } ?></center></td>
                        <td><center><?php if($q['blok5']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    }; ?></center></td>
                        <td><center><?php if($q['blok6']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    }; ?></center></td>
                        <td><center><?php if($q['blok7']==1){
                                        echo '<i class="fa fa-check" style="color:green"></i>';
                                    } else {
                                        echo '<i class="fa fa-close" style="color:red"></i>';
                                    }; ?></center></td>
