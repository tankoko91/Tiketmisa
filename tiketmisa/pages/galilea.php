											...
											<div class="penumpang">
												<div class="row">
													...
													<div class="col-md-5">
														...
														Blok Kursi :
														<p class="rincian"><b>GALILEA (Utama)</b></p>
														</blockquote>
														
													</div>
													<div class="col-md-6">
														<center><img src="assets/images/denah/galilea.png" width="60%"><br>
																...
																<tbody>
																    ...
																    for($x = 1; $x <= 4; $x++) {
                                                                      echo '<td>';
                                                                        ...
                                                                        echo '" value="' . $x . '" onclick="myFunction(' . $x . ')">00' . $x . '</button>';
                                                                        if (in_array($x,$kursipakai)){
																    ...
																    for($x = 12; $x <= 14; $x++) {
                                                                      echo '<td>';
                                                                        ...
                                                                        echo '" value="' . $x . '" onclick="myFunction(' . $x . ')">0' . $x . '</button>';
                                                                        if (in_array($x,$kursipakai)){
