            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo $_SESSION["staff"]["nama"]; ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                        <a href="home.php?p=profil-staff" class="btn btn-default btn-flat"><i class="fa fa-user"> Profil</i></a>
                    </div>
      ...
      <aside class="main-sidebar" style="margin-top: 60px;">
        ...
        <section class="sidebar" style="">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
				<a href="home.php?p=list-pemesanan">
                <i class="fa fa-shopping-cart"></i> <span>List Pemesanan</span>
				</a>
              </ul>
            </li>
